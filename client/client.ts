...
class Client {
    ...
    constructor(host: string) {
        ...
        this.productClient  = new productProto.product.ProductoService(host, grpc.credentials.createInsecure());
    }
    ...
    async createProduct(name: string, unique_code: string, size: string, image_url: Text, color: string, enabled:Boolean): Promise<any> {
        return new Promise((resolve, reject) => {
